...
// plus Google Fonts, Stripe (Stripe.js + in-page embedded checkout), and the
// Microsoft Advertising UET tag (Bing, bat.bing.com/.net). Everything else is
// locked to same-origin.
const CSP = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://js.stripe.com https://checkout.stripe.com https://m.stripe.network https://bat.bing.com https://bat.bing.net",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' https://fonts.gstatic.com",
  "img-src 'self' data: https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://www.google.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://*.stripe.com https://bat.bing.com",
  "connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://api.stripe.com https://checkout.stripe.com https://m.stripe.com https://r.stripe.com https://bat.bing.com https://bat.bing.net",
  "frame-src https://td.doubleclick.net https://googleads.g.doubleclick.net https://www.googletagmanager.com https://js.stripe.com https://checkout.stripe.com https://hooks.stripe.com https://m.stripe.network",
  "form-action 'self'",
