...
const PLANS = {
  Solo: {
    m: { amount: 1499,  interval: 'month', label: 'SpamCallStop Solo (monthly)' },
    y: { amount: 14900, interval: 'year',  label: 'SpamCallStop Solo (yearly)' },
  },
  Dual: {
    m: { amount: 2299,  interval: 'month', label: 'SpamCallStop Dual (monthly)' },
    y: { amount: 22900, interval: 'year',  label: 'SpamCallStop Dual (yearly)' },
  },
};
